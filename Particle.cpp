...
bool Particle::init(SDL_Renderer *renderer)
{
	...
	if (!sRedParticle.textureIsLoaded())
	{
		...
		//Load red texture
		if (!sRedParticle.loadFromFile("38_particle_engines/red.bmp", { 0, 255, 255 }))
		{
		...
		//Load green texture
		if (!sGreenParticle.loadFromFile("38_particle_engines/green.bmp", { 0, 255, 255 }))
		{
		...
		//Load blue texture
		if (!sBlueParticle.loadFromFile("38_particle_engines/blue.bmp", { 0, 255, 255 }))
		{
		...
		if (!sShimmer.loadFromFile("38_particle_engines/shimmer.bmp", { 0, 255, 255 }))
		{
